...
const Navbar = () => {
    ...
    // Fetch session directly using Better Auth hook
    const { data: session, isPending } = authClient.useSession();
    const user = session?.user;
    const isLoggedIn = !!session;

    // Handle Sign Out with Better Auth
                        ...
                        <div className="dropdown dropdown-end">
                            ...
                            >
                                <li className="menu-title px-4 py-1 text-xs text-gray-500 border-b border-gray-200 mb-1">
                                    {user?.name || user?.email || "User Dashboard"}
                                </li>
                                <li>
                                    <Link
                                        href="/my-bookings"
                                ...
                                <li>
                                    <button
                                        ...
                                        className="text-red-600 font-medium hover:bg-red-50 w-full text-left"
                                    >
                                        Logout
                                    </button>
                                </li>
